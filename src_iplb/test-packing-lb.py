...
log_file_path = "../records/project_log_lb.log"
...
log_file_path=f'../records/lb_{args.stepsize}_{args.primalweight}.log'
...
#         print(tmp)
    ...
    # solving:
    if solve:
#         solver.set_solver_specific_parameters('termination_criteria {simple_optimality_criteria {eps_optimal_relative: 1e-4}}')
...
dataset = []    
fp=gzip.open('../data/lb/lp_1.pkl','rb')
pk=pickle.load(fp)
fp.close()
print('Pickle Loaded')
...
log_path = f'../records/'+f"test_time_{stp}_{pwg}"+ name+'.csv'
