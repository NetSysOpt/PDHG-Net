...
import time
log_file_path = "../records/project_log_lb_small.log"
...
log_file_path=f'../records/lb_small_{args.stepsize}_{args.primalweight}.log'
...
model_path = '../models/'+ 'lb_small_' + str(n_Samples) + '_s' + str(embSize) + '.pkl'
# set_seed(0)
...
for i in range(n_files[1]):
    modelz = BuildRandomizedModels(i+10000)
