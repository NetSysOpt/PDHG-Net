...
#     params.initial_step_size_scaliong = 0.4
...
dataset = []    
fp=gzip.open('/code/GNN-LP/benchmarks/lb/lp_1.pkl','rb')
pk=pickle.load(fp)
fp.close()
print('Pickle Loaded')
...
model_path = '/code/GNN-LP/models/'+ 'lb_small_' + str(n_Samples) + '_s' + str(embSize) + '.pkl'
# set_seed(0)
...
for i in range(n_files[1]):
    ...
    stt=modelz.export_to_mps_string()
    f=gzip.open('/code/GNN-LP/sol_pkl/ipsmall.mps.gz','wb')
    f.write(stt.encode())
    f.close()