...
log_file_path = "../records/training_ip.log"
...
parser.add_argument("-c","--cont", type=int, default=1)
...
embSize = int(args.embSize)
model_path = '../models/ip_' + n_Samples + '_s' + str(embSize) + '.pkl'
...
while epoch <= max_epochs:
    ...
    for v_indx in range(n_train):
        ...
        savepath = f'../data/ip/lp_{int(sample_idx)}.pkl'
        try:
            fgz= gzip.open(savepath,'rb') 
